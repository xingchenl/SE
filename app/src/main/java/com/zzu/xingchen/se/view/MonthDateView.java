package com.zzu.xingchen.se.view;
...
import com.zzu.xingchen.se.util.MyDateUtils;

import java.util.Calendar;
import java.util.List;

/**
 * Created by xingchen on 2016/10/9.
 */
...
public class MonthDateView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        String dayString;
        int mMonthDays = MyDateUtils.getMonthDays(mSelYear, mSelMonth);
        int weekNumber =MyDateUtils.getFirstDayWeek(mSelYear, mSelMonth);
    ...
    public void onLeftClick(){
        ...
        }else if(MyDateUtils.getMonthDays(year, month) == day){
            //如果当前日期为该月最后一点，当向前推的时候，就需要改变选中的日期
            month = month-1;
            day = MyDateUtils.getMonthDays(year, month);
        }else{
            month = month-1;
        }
